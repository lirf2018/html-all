		...
		<div>
			<div class="search-form">
				<Form :model="searchForm" :label-width="120" :inline="true">
					<FormItem label="供应商名称"><Input placeholder="供应商名称" v-model="searchForm.supplier_name"
							@keyup.native="clickSearch()" /></FormItem>
					<FormItem label="供应商编码"><Input placeholder="供应商编码" v-model="searchForm.supplier_code"
							@keyup.native="clickSearch()" /></FormItem>
					<FormItem label="供应商电话"><Input placeholder="供应商编码" v-model="searchForm.supplier_phone"
							@keyup.native="clickSearch()" /></FormItem>
					<FormItem label="供应商地址"><Input placeholder="供应商编码" v-model="searchForm.supplier_addr"
							@keyup.native="clickSearch()" /></FormItem>
		...
		<div>
			<Modal v-model="addSupplierFlag" :title="title" @on-ok="saveData">
				<Form ref="addDataForm" :model="addFormData" :label-width="120" :rules="ruleValidate">
					<div class="item">
						<FormItem label="供应商编码" prop="supplierCode"><Input placeholder=""
								v-model="addFormData.supplierCode" /></FormItem>
					</div>
					<div class="item">
						<FormItem label="供应商名称" prop="supplierName"><Input placeholder=""
								v-model="addFormData.supplierName" /></FormItem>
					</div>
					<div class="item">
						<FormItem label="供应商电话" prop="supplierPhone"><Input placeholder=""
								v-model="addFormData.supplierPhone" /></FormItem>
					</div>
					<div class="item">
						<FormItem label="供应商地址" prop="supplierAddr"><Input placeholder=""
								v-model="addFormData.supplierAddr" /></FormItem>
					</div>
				</Form>
			</Modal>
