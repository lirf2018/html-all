		...
		<div>
			<div class="search-form">
				<Form :model="searchForm" :label-width="120" :inline="true">
					<FormItem label="参数名称"><Input placeholder="参数名称" v-model="searchForm.param_name"
							@keyup.native="clickSearch()" /></FormItem>
					<FormItem label="参数编码"><Input placeholder="参数编码" v-model="searchForm.param_code"
							@keyup.native="clickSearch()" /></FormItem>
					<FormItem label="参数key"><Input placeholder="参数key" v-model="searchForm.param_key"
							@keyup.native="clickSearch()" /></FormItem>
			...
			<div class="page-next">
				<Page :page-size="searchForm.page_size" show-total :total="total" show-sizer prev-text="上一页"
		...
		<div>
			<Modal v-model="addParamFlag" :title="title" @on-ok="saveData">
				<Form ref="formGoodsInfo" :model="addFormData" :label-width="120" :rules="ruleValidate">
					<div class="item">
						<FormItem label="参数名称" prop="paramName"><Input placeholder="参数名称"
								v-model="addFormData.paramName" /></FormItem>
					</div>
					<div class="item">
						<FormItem label="参数编码" prop="paramCode"><Input placeholder="参数编码"
								v-model="addFormData.paramCode" /></FormItem>
					</div>
					<div class="item">
						<FormItem label="参数key" prop="paramKey"><Input placeholder="参数key"
								v-model="addFormData.paramKey" /></FormItem>
					</div>
					<div class="item">
						<FormItem label="参数value1" prop="paramValue1"><Input placeholder="参数value1"
								v-model="addFormData.paramValue" /></FormItem>
					</div>
					<div class="item">
						<FormItem label="参数value2" prop="paramValue2"><Input placeholder="参数value2"
								v-model="addFormData.paramValue1" /></FormItem>
					</div>
					<div class="item">
						<FormItem label="参数value3" prop="paramValue3"><Input placeholder="参数value3"
								v-model="addFormData.paramValue2" /></FormItem>
					</div>
					<div class="item">
						<FormItem label="排序" prop="paramIndex"><Input string placeholder="排序"
								v-model="addFormData.paramIndex" /></FormItem>
					</div>
				</Form>
			</Modal>
