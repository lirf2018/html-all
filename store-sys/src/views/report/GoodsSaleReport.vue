<template>
	...
	<div class="">
		...
		<div class=""><Table show-summary :columns="columns" :data="data2" :summary-method="handleSummary"></Table></div>
		<div class="page-next">
			<Page :total="total2" :current="searchForm2.curre_page" :page-size="searchForm2.page_size" @on-change="changePage2" prev-text="上一页" next-text="下一页" />
		</div>
...
export default {
	...
	methods: {
		...
		searchData() {
			...
			if (this.showSearchCondition != 'year' && (this.searchConditionValue == null || this.searchConditionValue == '')) {
				vm.$Message.warning({ content: msg, duration: 5 });
				return;
			}
		...
		intDataTitle() {
			this.data = [
				{ goodsName: '商品8', inprice: 10, outprice: 15, getprice: 0 },
				{ goodsName: '商品9', inprice: 10, outprice: 10, getprice: 0 },
				{ goodsName: '商品10', inprice: 10, outprice: 10, getprice: 0 },
				{ goodsName: '商品11', inprice: 10, outprice: 10, getprice: 0 },
				{ goodsName: '商品12', inprice: 10, outprice: 10, getprice: 0 }
			];
		},
