<template>
	<div class="body-bg">
		...
		<van-tabs v-model="active" type="card" color="#008000">
			<van-tab title="送货上门">
			...
			<van-tab title="站点自提">
				<div class="ziti">
					<div class="show-addr">
						...
						<div>
							<span>深圳市龙岗区布吉镇坂岗区布吉镇坂岗吉镇坂岗区岗区布吉</span>
						</div>
					</div>
					<div class="user-info">
						<div style="" >
		...
		<van-popup v-model="addrList" position="bottom" closeable :style="{ height: '100%' }"><AddrListVue /></van-popup>
		<van-popup v-model="showAddr" position="bottom" closeable :style="{ height: '100%' }"><UserAddrVue /></van-popup>
	</div>
</template>
...
import AddrListVue from '@/components/AddrList.vue';
export default {
