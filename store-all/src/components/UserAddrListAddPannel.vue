<template>
	<div class="body-bg">
		<div class="close-head">
			<div class="close-x">
				<van-icon name="close" @click="closeShowUserAddrAddFlag" />
			</div>
		</div>
		<div class="addrs-list">
			<div style="height:30px;"></div>
			<div class="user-info user-data">
				<div>
...
<script>
	...
	export default {
		...
		props: ["setShowUserAddrAddFlag"],
		watch: {
			setShowUserAddrAddFlag: function(valueOld, valueNew) {
		...
		methods: {
			...
			closeShowUserAddrAddFlag() {
				this.setShowUserAddrAddFlag();
			}
		}
	};
</script>
